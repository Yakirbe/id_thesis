...
color1 = sRGBColor(0, 0, 251)
color1 = convert_color(color1, LabColor)#, target_illuminant='D50')
# Color to be compared to the reference.
color2 = sRGBColor(0, 0, 255)
color2 = convert_color(color2, LabColor)#, target_illuminant='D50')
