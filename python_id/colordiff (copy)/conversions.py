...
def example_rgb_to_xyz():
    ...
    # Instantiate an Lab color object with the given values.
    rgb = sRGBColor(0, 0, 255)
    # Show a string representation.
    print(rgb)
    # Convert RGB to XYZ using a D50 illuminant.
    #xyz = convert_color(rgb, XYZColor, target_illuminant='D50')
    xyz = convert_color(rgb, LabColor)#, target_illuminant='D50')
    print(xyz)
    print("=== End Example ===\n")
...
print("=== RGB Example: RGB->XYZ ===")
# Instantiate an Lab color object with the given values.
rgb = sRGBColor(100.0/100,100.0/100, 255.0/100)
# Show a string representation.
print(rgb)
# Convert RGB to XYZ using a D50 illuminant.
xyz = convert_color(rgb, LabColor, target_illuminant='D65')
print(xyz)
example_lab_to_rgb(xyz.get_value_tuple())
